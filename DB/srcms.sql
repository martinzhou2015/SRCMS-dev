...
--
-- Host: localhost
-- Generation Time: 2017-11-03 13:22:54
-- 服务器版本： 5.5.40
-- PHP Version: 5.5.17
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='报告评论';
...
(1, 'admin', '1009465756@qq.com', '21232f297a57a5a743894a0e4a801fc3', '3057ad15f751f40f58e9c2b5f6751ec6', '0.0.0.0', '1453778451', '1509603250');
...
--
ALTER TABLE `comment`
  MODIFY `id` int(255) NOT NULL AUTO_INCREMENT COMMENT '评论编号';
--
